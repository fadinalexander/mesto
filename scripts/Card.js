...
class Card {
    ...
    _handleCardDelete() {
        ...
        //занулим объект, так как метод remove() удалит только разметку карточки, но сам объект с данными и его слушателями останутся в памяти приложения. Null - решит эту проблему
        this._element = null
    }
